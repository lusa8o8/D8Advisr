...
export default function Screen20Badges() {
  ...
  return (
    <div className="flex-1 min-h-0 flex flex-col relative bg-background">
      ...
      <div className="px-6 pt-14 pb-4 bg-white border-b border-border flex items-center gap-4 sticky top-0 z-20">
        ...
        <div className="ml-auto flex items-center gap-1.5 bg-[#FF5A5F]/10 px-3 py-1.5 rounded-full">
          <Trophy size={14} className="text-[#FF5A5F]" />
          <span className="text-xs font-bold text-[#FF5A5F]">{EARNED.length} earned</span>
        </div>
      </div>

      <div className="flex-1 min-h-0 overflow-y-auto pb-10">
        {/* Stats Strip */}
        <div className="mx-6 mt-5 mb-6 bg-white rounded-2xl border border-[#EBEBEB] shadow-sm grid grid-cols-3 divide-x divide-[#EBEBEB]">
